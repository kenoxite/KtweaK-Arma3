...
if (_genIndex == 0) then {
    if ("pvs14" in _itemClassLower || "pvs31" in _itemClassLower || "pvs15" in _itemClassLower || "gpnvg" in _itemClassLower || "tpnvg" in _itemClassLower || "1pn138" in _itemClassLower || "psq42" in _itemClassLower) then { _genIndex = 4 };
